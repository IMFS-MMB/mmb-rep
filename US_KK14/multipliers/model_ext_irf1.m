...
erase_compiled_function('model_ext_irf1_static');
erase_compiled_function('model_ext_irf1_dynamic');
M_.orig_eq_nbr = 29;
M_.eq_nbr = 29;
M_.ramsey_eq_nbr = 0;
...
disp('... done!')
save('model_ext_irf1_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('model_ext_irf1_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('model_ext_irf1_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('model_ext_irf1_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('model_ext_irf1_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('model_ext_irf1_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('model_ext_irf1_results.mat', 'oo_recursive_', '-append');
end
