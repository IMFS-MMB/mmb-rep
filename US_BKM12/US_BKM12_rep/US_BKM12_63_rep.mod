...
%	No wage indexation and no sticky wages.						%
%											%
...
csigma=   1.269;
chabb=    0.637;
cprobw = 0.0001;     %	Set to 0 to get rid of sticky wages;
csigl=    1.060;
cprobp = 0.688;     	%Set to match the BLS frequency
cindw = 0;       	%Set to remove wage indexation
cindp = 0.000;       	%Set to remove price indexation
czcap=    0.647;
cfc=	1.723;
crpi=     1.398;
crr=      0.884;
