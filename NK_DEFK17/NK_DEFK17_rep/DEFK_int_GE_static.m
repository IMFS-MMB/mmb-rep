function [residual, g1, g2, g3] = DEFK_int_GE_static(y, x, params)
%
...
T263 = getPowerDeriv(y(1),(-params(2)),1);
T302 = getPowerDeriv(y(5)/y(8),1-params(6),1);
T309 = getPowerDeriv(y(8)/y(5),params(6),1);
T328 = getPowerDeriv(T204,1-params(16),1);
T383 = (params(4)*(y(16)-y(15)*params(5))-params(4)*(y(15)-y(16))*(-params(5)))/((y(16)-y(15)*params(5))*(y(16)-y(15)*params(5)));
T417 = ((y(16)-y(15)*params(5))*(-params(4))-params(4)*(y(15)-y(16)))/((y(16)-y(15)*params(5))*(y(16)-y(15)*params(5)));
T447 = getPowerDeriv(y(23),1/params(10),1);
T474 = (-(y(14)*y(11)*y(6)))/(y(27)*y(27));
T477 = getPowerDeriv(y(27),1/params(11),1);
T485 = getPowerDeriv(y(27),(1+params(11))/params(11),1);
  g1(1,1)=T263-T25*y(19)*params(1)*T263;
  g1(1,15)=(-(T11*params(1)*y(19)*T383));
  g1(1,16)=(-(T11*params(1)*y(19)*T417));
  g1(1,19)=(-(T11*params(1)*T25));
  g1(2,1)=T263-T42*T33*params(1)*T263;
  ...
  g1(7,30)=y(6);
  g1(8,5)=(-(params(32)*params(6)*y(26)*1/y(8)*T302));
  g1(8,8)=(-(params(32)*params(6)*y(26)*T302*(-y(5))/(y(8)*y(8))));
  g1(8,18)=1;
  g1(8,26)=(-(T96*params(32)*params(6)));
  g1(9,5)=(-(params(32)*(1-params(6))*y(26)*(-y(8))/(y(5)*y(5))*T309));
  g1(9,8)=(-(params(32)*(1-params(6))*y(26)*T309*1/y(5)));
  g1(9,22)=1;
  ...
  g1(13,27)=(-(y(29)*(-(params(13)*T477))/(1-params(13))*getPowerDeriv(T128,(-params(11)),1)));
  g1(13,28)=1;
  g1(13,29)=(-T130);
  g1(14,1)=(-(y(26)*y(6)*(1+params(11))*T263));
  g1(14,6)=(-(y(26)*T11*(1+params(11))));
  g1(14,26)=(-(y(6)*T11*(1+params(11))));
  g1(14,27)=(-(y(28)*params(1)*params(13)*T485));
  g1(14,28)=1-params(1)*params(13)*T139;
  g1(15,1)=(-(y(6)*T263));
  g1(15,6)=(-T11);
  g1(15,27)=(-(y(29)*params(1)*params(13)*T477));
  g1(15,29)=1-T124*params(1)*params(13);
  g1(16,23)=(-(y(25)*(-(params(12)*T447))/(1-params(12))*getPowerDeriv((1-params(12)*T155)/(1-params(12)),(-(params(10)+(1+params(10))*params(3))),1)));
  g1(16,24)=1;
  g1(16,25)=(-T165);
  ...
  g1(17,24)=1-T175;
  g1(18,1)=(-(y(5)*y(22)*T263));
  g1(18,5)=(-(T11*y(22)));
  g1(18,22)=(-(T11*y(5)));
  g1(18,23)=(-(y(25)*params(1)*params(12)*T447));
  g1(18,25)=1-T155*params(1)*params(12);
  g1(19,22)=y(27)-y(23);
  g1(19,23)=(-y(22));
  g1(19,27)=y(22);
  g1(20,27)=(-(y(30)*params(13)*T485+(1-params(13))*(-(params(13)*T477))/(1-params(13))*getPowerDeriv(T128,1+params(11),1)));
  g1(20,30)=1-params(13)*T139;
  g1(21,6)=(-(T195*T199*1/params(20)*getPowerDeriv(y(6)/params(20),params(15),1)*T328*(T207>1)));
  g1(21,14)=1-(T207>1)*T206*getPowerDeriv(y(14),params(16),1);
  g1(21,27)=(-((T207>1)*T195*T328*T203*params(25)*getPowerDeriv(y(27),params(14),1)));
  g1(22,10)=1;
  g1(22,33)=(-params(17));
  ...
  g1(31,13)=1;
  g1(31,16)=(-y(2));
  g1(32,1)=T263-params(1)*y(20)*T263;
