...
options_ = [];
M_.fname = 'US_BKM12_41_rep';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('US_BKM12_41_rep.log');
M_.exo_names = 'ea';
M_.exo_names_tex = 'ea';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('US_BKM12_41_rep_static');
erase_compiled_function('US_BKM12_41_rep_dynamic');
...
oo_.steady_state( 2 ) = 100*((1+M_.params(5)/100)/(1/(1+M_.params(6)/100)*(1+M_.params(34)/100)^(-M_.params(14)))-1);
...
make_ex_;
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = (1.260)^2;
M_.Sigma_e(2, 2) = (.030)^2;
M_.Sigma_e(3, 3) = (.573)^2;
M_.Sigma_e(4, 4) = (.240)^2;
M_.Sigma_e(5, 5) = (0.044)^2;
M_.Sigma_e(6, 6) = (0.283)^2;
M_.Sigma_e(7, 7) = (0.519)^2;
steady;
options_.drop = 200;
options_.irf = 100;
options_.noprint = 1;
...
var_list_ = char(var_list_, 'inve');
var_list_ = char(var_list_, 'lab');
var_list_ = char(var_list_, 'pinf');
var_list_ = char(var_list_, 'wf');
var_list_ = char(var_list_, 'yf');
var_list_ = char(var_list_, 'cf');
var_list_ = char(var_list_, 'invef');
info = stoch_simul(var_list_);
save('US_BKM12_41_rep_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('US_BKM12_41_rep_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('US_BKM12_41_rep_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('US_BKM12_41_rep_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('US_BKM12_41_rep_results.mat', 'estimation_info', '-append');
end
