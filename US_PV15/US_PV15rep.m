...
erase_compiled_function('US_PV15rep_static');
erase_compiled_function('US_PV15rep_dynamic');
M_.orig_eq_nbr = 115;
M_.eq_nbr = 117;
M_.ramsey_eq_nbr = 0;
...
options_.irf = 25;
options_.order = 1;
var_list_ = char('ln_yd','ln_c','ln_i','ln_pi','ln_y','ln_n','ln_v','ln_r','ln_yn');
info = stoch_simul(var_list_);
save('US_PV15rep_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('US_PV15rep_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('US_PV15rep_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('US_PV15rep_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('US_PV15rep_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('US_PV15rep_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('US_PV15rep_results.mat', 'oo_recursive_', '-append');
end
