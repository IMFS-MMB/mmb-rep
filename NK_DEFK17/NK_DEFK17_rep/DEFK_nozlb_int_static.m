function [residual, g1, g2, g3] = DEFK_nozlb_int_static(y, x, params)
%
...
residual(31)= lhs-rhs;
lhs =y(32);
rhs =params(33)*(1-params(19))+y(32)*params(19)+x(1);
residual(32)= lhs-rhs;
if ~isreal(residual)
...
T258 = getPowerDeriv(y(1),(-params(2)),1);
T294 = getPowerDeriv(y(5)/y(8),1-params(6),1);
T301 = getPowerDeriv(y(8)/y(5),params(6),1);
T370 = (params(4)*(y(16)-y(15)*params(5))-params(4)*(y(15)-y(16))*(-params(5)))/((y(16)-y(15)*params(5))*(y(16)-y(15)*params(5)));
T404 = ((y(16)-y(15)*params(5))*(-params(4))-params(4)*(y(15)-y(16)))/((y(16)-y(15)*params(5))*(y(16)-y(15)*params(5)));
T433 = getPowerDeriv(y(22),1/params(10),1);
T460 = (-(y(14)*y(11)*y(6)))/(y(26)*y(26));
T463 = getPowerDeriv(y(26),1/params(11),1);
T471 = getPowerDeriv(y(26),(1+params(11))/params(11),1);
  g1(1,1)=T258-T25*y(19)*params(1)*T258;
  g1(1,15)=(-(T11*params(1)*y(19)*T370));
  g1(1,16)=(-(T11*params(1)*y(19)*T404));
  g1(1,19)=(-(T11*params(1)*T25));
  g1(2,1)=T258-T42*T33*params(1)*T258;
  ...
  g1(7,29)=y(6);
  g1(8,5)=(-(params(32)*params(6)*y(25)*1/y(8)*T294));
  g1(8,8)=(-(params(32)*params(6)*y(25)*T294*(-y(5))/(y(8)*y(8))));
  g1(8,18)=1;
  g1(8,25)=(-(T96*params(32)*params(6)));
  g1(9,5)=(-(params(32)*(1-params(6))*y(25)*(-y(8))/(y(5)*y(5))*T301));
  g1(9,8)=(-(params(32)*(1-params(6))*y(25)*T301*1/y(5)));
  g1(9,21)=1;
  ...
  g1(13,26)=(-(y(28)*(-(params(13)*T463))/(1-params(13))*getPowerDeriv(T128,(-params(11)),1)));
  g1(13,27)=1;
  g1(13,28)=(-T130);
  g1(14,1)=(-(y(25)*y(6)*(1+params(11))*T258));
  g1(14,6)=(-(y(25)*T11*(1+params(11))));
  g1(14,25)=(-(y(6)*T11*(1+params(11))));
  g1(14,26)=(-(y(27)*params(1)*params(13)*T471));
  g1(14,27)=1-params(1)*params(13)*T139;
  g1(15,1)=(-(y(6)*T258));
  g1(15,6)=(-T11);
  g1(15,26)=(-(y(28)*params(1)*params(13)*T463));
  g1(15,28)=1-T124*params(1)*params(13);
  g1(16,22)=(-(y(24)*(-(params(12)*T433))/(1-params(12))*getPowerDeriv((1-params(12)*T155)/(1-params(12)),(-(params(10)+(1+params(10))*params(3))),1)));
  g1(16,23)=1;
  g1(16,24)=(-T165);
  ...
  g1(17,23)=1-T175;
  g1(18,1)=(-(y(5)*y(21)*T258));
  g1(18,5)=(-(T11*y(21)));
  g1(18,21)=(-(T11*y(5)));
  g1(18,22)=(-(y(24)*params(1)*params(12)*T433));
  g1(18,24)=1-T155*params(1)*params(12);
  g1(19,21)=y(26)-y(22);
  g1(19,22)=(-y(21));
  g1(19,26)=y(21);
  g1(20,26)=(-(y(29)*params(13)*T471+(1-params(13))*(-(params(13)*T463))/(1-params(13))*getPowerDeriv(T128,1+params(11),1)));
