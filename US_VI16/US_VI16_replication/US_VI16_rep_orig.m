...
erase_compiled_function('US_VI16_rep_orig_static');
erase_compiled_function('US_VI16_rep_orig_dynamic');
M_.orig_eq_nbr = 60;
M_.eq_nbr = 60;
M_.ramsey_eq_nbr = 0;
...
M_.params( 18 ) = M_.params(6)/(M_.params(6)-1);
M = M_.params( 18 );
M_.params( 8 ) = 0.20;
G_Y = M_.params( 8 );
M_.params( 2 ) = 1.81;
...
M_.params( 20 ) = 0.23;
rho_ri = M_.params( 20 );
M_.params( 31 ) = 1.013860066271978;
RK = M_.params( 31 );
M_.params( 32 ) = 0;
constelab = M_.params( 32 );
steady;
...
estim_params_.param_vals = [estim_params_.param_vals; 23, 0.9493, .01, .99999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 26, 0.9802, .01, .99999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 24, 0.9624, .01, .9999999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 25, 0.9914, .01, .9999999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 20, 0.2154, (-0.02), .9999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 28, 0.2101, .01, .99999, 1, 0.5, 0.20, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 27, 0.1907, .001, .9999, 1, 0.5, 0.20, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 29, 1.3488, 1.0, 3, 3, 1.45, 0.125, NaN, NaN, NaN ];
...
estim_params_.param_vals = [estim_params_.param_vals; 21, 1.8855, 1.0, 3, 3, 1.7, 0.15, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 19, 0.8495, 0.35, 0.975, 1, 0.75, 0.10, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 22, 0.0743, (-0.065), 0.5, 2, .125, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 30, 0.2004, (-0.1), 0.5, 3, 0.0625, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 33, 0.6473, 0.1, 2.0, 2, 0.625, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 34, 0.3029, 0.001, 0.8, 3, 0.4, 0.10, NaN, NaN, NaN ];
options_.plot_priors=0;
options_.irf = 20;
options_.nograph = 1;
var_list_ = char('y','i','pi','n','ext_pr');
info = stoch_simul(var_list_);
save('US_VI16_rep_orig_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('US_VI16_rep_orig_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('US_VI16_rep_orig_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('US_VI16_rep_orig_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('US_VI16_rep_orig_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('US_VI16_rep_orig_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('US_VI16_rep_orig_results.mat', 'oo_recursive_', '-append');
end
