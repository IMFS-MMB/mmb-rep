...
//**************************************************************************
// Modelbase Variables                                                   
        interest inflation inflationq outputgap output pinflag1 pinflag2 dlab realinterest mcf pinfobs4 robs4 gry interesttarget gadd;            
//**************************************************************************
...
cgamma=ctrend/100+1;
csigma=1.3808;//coefficient of realtive risk aversion
...
//**************************************************************************                                                                    
// Policy Rule     
interesttarget= 4*conster +cofintintb1*interest(-1)                                    //* 
           + cofintinf0*inflationq                                       //* 
           + cofintinfb1*inflationq(-1)                                  //* 
           + cofintout*outputgap 	                                     //* 
           + cofintoutb1*outputgap(-1)+4*ms; 

                              //* 
robs4 =   dummy_MP*0.5*(((interesttarget+0.000000000001)^2)^0.5+interesttarget)+(1-dummy_MP)*interesttarget;                                   //*                                              //*              
//**************************************************************************
...
// flexible economy
	      ...
	      yf = ccy*cf+ciy*invef+g  + gadd +  crkky*zcapf ;
...
// sticky price - wage economy
          ...
          //aggregate resource constraint
	      y = ccy*c+ciy*inve+g + gadd +  1*crkky*zcap ;
          // aggregate production function
