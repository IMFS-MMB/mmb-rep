...
%as a response to positive technology shock AND public employment shock.
%Replicates Figure 2 (red dashed line) of Michaillat(2014)
clear 

cd([cd '/NK_MI14_rep']);

dynare NK_MI14_rep_pos_nog
...
figure(3) %combine several plots to obtain Figure 2
subplot(3,2,1)   
...
mult_ts.Name = 'Multiplier after positive shock';
mult_ts.TimeInfo.Units = 'weeks';
figure(4)
plot(mult_ts,'-r','Linewidth',2);
title('Multiplier after positive shock')