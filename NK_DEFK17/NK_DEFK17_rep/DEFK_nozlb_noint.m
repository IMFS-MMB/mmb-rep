...
erase_compiled_function('DEFK_nozlb_noint_static');
erase_compiled_function('DEFK_nozlb_noint_dynamic');
M_.orig_eq_nbr = 32;
M_.eq_nbr = 32;
M_.ramsey_eq_nbr = 0;
...
oo_.steady_state( 20 ) = M_.params(27)/M_.params(26)+1-M_.params(8);
oo_.steady_state( 31 ) = oo_.steady_state(20)-oo_.steady_state(19);
oo_.steady_state( 15 ) = M_.params(26);
oo_.steady_state( 16 ) = 1;
oo_.steady_state( 17 ) = M_.params(27);
oo_.steady_state( 18 ) = M_.params(28);
oo_.steady_state( 30 ) = CY_ss;
oo_.steady_state( 21 ) = M_.params(29);
oo_.steady_state( 22 ) = 1;
oo_.steady_state( 23 ) = (1+M_.params(10))*M_.params(24)^(1+M_.params(3))/(1-M_.params(1)*M_.params(12));
oo_.steady_state( 24 ) = M_.params(24)*M_.params(29)*M_.params(21)^(-M_.params(2))/(1-M_.params(1)*M_.params(12));
oo_.steady_state( 25 ) = 1/(1+M_.params(11));
oo_.steady_state( 26 ) = 1;
oo_.steady_state( 27 ) = M_.params(20)*M_.params(21)^(-M_.params(2))/(1-M_.params(1)*M_.params(13));
oo_.steady_state( 28 ) = M_.params(20)*M_.params(21)^(-M_.params(2))/(1-M_.params(1)*M_.params(13));
oo_.steady_state( 29 ) = 1;
oo_.steady_state( 32 ) = M_.params(33);
...
save('DEFK_nozlb_noint_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('DEFK_nozlb_noint_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('DEFK_nozlb_noint_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('DEFK_nozlb_noint_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('DEFK_nozlb_noint_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('DEFK_nozlb_noint_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('DEFK_nozlb_noint_results.mat', 'oo_recursive_', '-append');
end
