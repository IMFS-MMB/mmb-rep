...
options_ = [];
M_.fname = 'NK_GLSV07_pclm_rep';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('NK_GLSV07_pclm_rep.log');
M_.exo_names = 'e_g';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('NK_GLSV07_pclm_rep_static');
erase_compiled_function('NK_GLSV07_pclm_rep_dynamic');
...
M_.params( 15 ) = 0.9;
rho_g = M_.params( 15 );
M_.params( 22 ) = 1/(M_.params(13)*M_.params(3)*M_.params(21)+(1-M_.params(1))*(1-M_.params(11)*(1+M_.params(21))));
gamma = M_.params( 22 );
M_.params( 16 ) = 1/((1-M_.params(11))*M_.params(22)*(1-M_.params(1)+M_.params(3)*M_.params(13)*M_.params(21)));
sigma_bar = M_.params( 16 );
M_.params( 20 ) = M_.params(7)*(1-M_.params(2)*(1-M_.params(6)))*(1-M_.params(4));
omega = M_.params( 20 );
M_.params( 10 ) = M_.params(21)*M_.params(13)*M_.params(11)*M_.params(22);
theta_tau = M_.params( 10 );
M_.params( 9 ) = M_.params(21)*(1+M_.params(21))*(1-M_.params(1))*M_.params(11)*M_.params(22);
theta_n = M_.params( 9 );
%
...
save('NK_GLSV07_pclm_rep_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('NK_GLSV07_pclm_rep_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('NK_GLSV07_pclm_rep_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('NK_GLSV07_pclm_rep_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('NK_GLSV07_pclm_rep_results.mat', 'estimation_info', '-append');
end
