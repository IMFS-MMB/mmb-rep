...
M_.endo_names = char(M_.endo_names, 'iot');
M_.endo_names_tex = char(M_.endo_names_tex, 'iot');
M_.endo_names_long = char(M_.endo_names_long, 'iot');
...
M_.endo_names = char(M_.endo_names, 'log_infl');
M_.endo_names_tex = char(M_.endo_names_tex, 'log\_infl');
M_.endo_names_long = char(M_.endo_names_long, 'log_infl');
M_.endo_names = char(M_.endo_names, 'log_r');
M_.endo_names_tex = char(M_.endo_names_tex, 'log\_r');
M_.endo_names_long = char(M_.endo_names_long, 'log_r');
M_.endo_names = char(M_.endo_names, 'log_c');
M_.endo_names_tex = char(M_.endo_names_tex, 'log\_c');
M_.endo_names_long = char(M_.endo_names_long, 'log_c');
M_.endo_names = char(M_.endo_names, 'log_inv');
M_.endo_names_tex = char(M_.endo_names_tex, 'log\_inv');
M_.endo_names_long = char(M_.endo_names_long, 'log_inv');
M_.endo_names = char(M_.endo_names, 'log_tfp');
M_.endo_names_tex = char(M_.endo_names_tex, 'log\_tfp');
M_.endo_names_long = char(M_.endo_names_long, 'log_tfp');
...
M_.param_names = 'rho_a';
M_.param_names_tex = 'rho\_a';
M_.param_names_long = 'rho_a';
M_.param_names = char(M_.param_names, 'rho_iot');
M_.param_names_tex = char(M_.param_names_tex, 'rho\_iot');
M_.param_names_long = char(M_.param_names_long, 'rho_iot');
...
erase_compiled_function('productivity_shock_static');
erase_compiled_function('productivity_shock_dynamic');
M_.orig_eq_nbr = 40;
M_.eq_nbr = 40;
M_.ramsey_eq_nbr = 0;
...
M_.params( 7 ) = 0.79246;
theta = M_.params( 7 );
M_.params( 6 ) = 0.009486;
kappa = M_.params( 6 );
M_.params( 10 ) = 0.024291;
delta = M_.params( 10 );
M_.params( 8 ) = 0.34002;
gamma = M_.params( 8 );
M_.params( 11 ) = 0.75;
...
M_.params( 22 ) = 2.6779;
Y_ss = M_.params( 22 );
M_.params( 25 ) = 29.2064;
K_ss = M_.params( 25 );
M_.params( 26 ) = 0.90345;
H_ss = M_.params( 26 );
M_.params( 24 ) = 0.70945;
I_ss = M_.params( 24 );
M_.params( 23 ) = 1.9685;
C_ss = M_.params( 23 );
M_.params( 28 ) = 1.0223;
Q_ss = M_.params( 28 );
M_.params( 29 ) = 0.031176;
RK_ss = M_.params( 29 );
M_.params( 30 ) = 0.031176;
rK_ss = M_.params( 30 );
CY_ss=0.0011116;
M_.params( 31 ) = 1.9563;
w_ss = M_.params( 31 );
M_.params( 32 ) = 0.023387;
tau_ss = M_.params( 32 );
KY_ratio=10.9064;
KH_ratio=32.3277;
IY_ratio=0.26493;
...
psi_k = M_.params( 19 );
M_.params( 36 ) = (-0.218);
shock_val = M_.params( 36 );
M_.params( 21 ) = 0.9525;
rho_phi = M_.params( 21 );
GE=0;
M_.params( 1 ) = 0.95;
rho_a = M_.params( 1 );
%
...
oo_.steady_state( 1 ) = M_.params(34);
oo_.steady_state( 9 ) = M_.params(23);
oo_.steady_state( 10 ) = M_.params(24);
oo_.steady_state( 11 ) = 0;
oo_.steady_state( 12 ) = 0;
oo_.steady_state( 13 ) = M_.params(26);
oo_.steady_state( 14 ) = M_.params(22);
oo_.steady_state( 19 ) = M_.params(33);
oo_.steady_state( 15 ) = M_.params(32);
oo_.steady_state( 16 ) = M_.params(25);
oo_.steady_state( 17 ) = M_.params(25);
oo_.steady_state( 18 ) = 0;
oo_.steady_state( 22 ) = M_.params(27);
oo_.steady_state( 27 ) = M_.params(27);
oo_.steady_state( 28 ) = M_.params(29)/M_.params(28)+1-M_.params(10);
oo_.steady_state( 39 ) = oo_.steady_state(28)-oo_.steady_state(27);
oo_.steady_state( 23 ) = M_.params(28);
oo_.steady_state( 24 ) = 1;
oo_.steady_state( 25 ) = M_.params(29);
oo_.steady_state( 26 ) = M_.params(30);
oo_.steady_state( 38 ) = CY_ss;
oo_.steady_state( 29 ) = M_.params(31);
oo_.steady_state( 30 ) = 1;
oo_.steady_state( 31 ) = (1+M_.params(12))*M_.params(26)^(1+M_.params(5))/(1-M_.params(3)*M_.params(14));
oo_.steady_state( 32 ) = M_.params(26)*M_.params(31)*M_.params(23)^(-M_.params(4))/(1-M_.params(3)*M_.params(14));
oo_.steady_state( 33 ) = 1/(1+M_.params(13));
oo_.steady_state( 34 ) = 1;
oo_.steady_state( 35 ) = M_.params(22)*M_.params(23)^(-M_.params(4))/(1-M_.params(3)*M_.params(15));
oo_.steady_state( 36 ) = M_.params(22)*M_.params(23)^(-M_.params(4))/(1-M_.params(3)*M_.params(15));
oo_.steady_state( 37 ) = 1;
oo_.steady_state( 40 ) = M_.params(35);
...
struct('exo_det',0,'exo_id',2,'multiplicative',0,'periods',1:1,'value',0.0045) ];
M_.exo_det_length = 0;
options_.periods = 300;
perfect_foresight_setup;
perfect_foresight_solver;
save('productivity_shock_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('productivity_shock_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('productivity_shock_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('productivity_shock_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('productivity_shock_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('productivity_shock_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('productivity_shock_results.mat', 'oo_recursive_', '-append');
end
