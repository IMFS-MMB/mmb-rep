...
M_.endo_names = char(M_.endo_names, 'R0');
M_.endo_names_tex = char(M_.endo_names_tex, 'R0');
M_.endo_names_long = char(M_.endo_names_long, 'R0');
...
erase_compiled_function('DEFK_flex_noint_static');
erase_compiled_function('DEFK_flex_noint_dynamic');
M_.orig_eq_nbr = 25;
M_.eq_nbr = 25;
M_.ramsey_eq_nbr = 0;
...
M_.params( 18 ) = 2.6779;
Y_ss = M_.params( 18 );
M_.params( 21 ) = 29.2064;
K_ss = M_.params( 21 );
M_.params( 22 ) = 0.90345;
H_ss = M_.params( 22 );
M_.params( 20 ) = 0.70945;
I_ss = M_.params( 20 );
M_.params( 19 ) = 1.9685;
C_ss = M_.params( 19 );
M_.params( 24 ) = 1.0223;
Q_ss = M_.params( 24 );
M_.params( 25 ) = 0.031176;
RK_ss = M_.params( 25 );
M_.params( 26 ) = 0.031176;
rK_ss = M_.params( 26 );
CY_ss=0.0011116;
M_.params( 27 ) = 1.9563;
w_ss = M_.params( 27 );
M_.params( 28 ) = 0.023387;
tau_ss = M_.params( 28 );
KY_ratio=10.9064;
KH_ratio=32.3277;
IY_ratio=0.26493;
...
psi_k = M_.params( 15 );
M_.params( 32 ) = (-0.218);
shock_val = M_.params( 32 );
M_.params( 17 ) = 0.9525;
rho_phi = M_.params( 17 );
GE=0;
%
...
oo_.steady_state( 2 ) = M_.params(20);
oo_.steady_state( 3 ) = 0;
oo_.steady_state( 4 ) = 0;
oo_.steady_state( 5 ) = M_.params(22);
oo_.steady_state( 6 ) = M_.params(18);
oo_.steady_state( 11 ) = M_.params(29);
oo_.steady_state( 7 ) = M_.params(28);
oo_.steady_state( 8 ) = M_.params(21);
oo_.steady_state( 9 ) = M_.params(21);
oo_.steady_state( 10 ) = 0;
oo_.steady_state( 14 ) = M_.params(23);
oo_.steady_state( 15 ) = M_.params(23)*(1+CY_ss);
oo_.steady_state( 20 ) = M_.params(25)/M_.params(24)+1-M_.params(8);
oo_.steady_state( 24 ) = oo_.steady_state(20)-oo_.steady_state(14);
oo_.steady_state( 16 ) = M_.params(24);
oo_.steady_state( 17 ) = 1;
oo_.steady_state( 18 ) = M_.params(25);
oo_.steady_state( 19 ) = M_.params(26);
oo_.steady_state( 23 ) = CY_ss;
oo_.steady_state( 21 ) = M_.params(27);
oo_.steady_state( 22 ) = 1/(1+M_.params(11));
oo_.steady_state( 25 ) = M_.params(31);
...
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',1:1,'value',M_.params(32)) ];
M_.exo_det_length = 0;
options_.periods = 300;
perfect_foresight_setup;
perfect_foresight_solver;
save('DEFK_flex_noint_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('DEFK_flex_noint_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('DEFK_flex_noint_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('DEFK_flex_noint_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('DEFK_flex_noint_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('DEFK_flex_noint_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('DEFK_flex_noint_results.mat', 'oo_recursive_', '-append');
end
