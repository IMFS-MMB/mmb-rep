function [residual, g1, g2] = US_CFP17_rep_exo_static(y, x, params)
%
...
T169 = (-4)*(params(54)-params(8))/params(54);
T211 = params(55)/params(58);
T215 = y(33)*T211+y(31)*(1-T211);
...
residual(3)= lhs-rhs;
lhs =y(19);
rhs =(params(3)*params(7)*y(20)-y(20)*T29+params(7)*y(20))/((1-params(3)*params(7))*(1-params(7)))+y(1)*(1-params(3)*params(7)*params(48))/(1-params(3)*params(7));
residual(4)= lhs-rhs;
lhs =y(48);
rhs =y(1)*(1-params(3)*params(7)*params(48))/(1-params(3)*params(7))+(params(3)*params(7)*y(49)-T29*y(49)+params(7)*y(49))/((1-params(3)*params(7))*(1-params(7)));
residual(5)= lhs-rhs;
lhs =y(2);
...
residual(26)= lhs-rhs;
lhs =y(71);
rhs =y(69)*T211+y(62)*(1-T211)-y(63);
residual(27)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(4,19)=1;
  g1(4,20)=(-((params(7)+params(3)*params(7)-T29)/((1-params(3)*params(7))*(1-params(7)))));
  g1(5,1)=(-((1-params(3)*params(7)*params(48))/(1-params(3)*params(7))));
  g1(5,48)=1;
  g1(5,49)=(-((params(7)+params(3)*params(7)-T29)/((1-params(3)*params(7))*(1-params(7)))));
  g1(6,1)=(-1);
  g1(6,2)=1;
  g1(6,19)=1;
  g1(6,21)=(-params(5));
