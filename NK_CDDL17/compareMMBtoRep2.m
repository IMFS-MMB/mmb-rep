...
% model where prudential policy is set optimally, the risky technology is
% not used and there is no moral hazard.
...
kappa_ez = 0.12 * exp(oo_.irfs.kpnk_ez);
...
kappa_et = 0.12 * exp(oo_.irfs.kpnk_et);
...
kappa_ez_MMB = 0.12 * exp(oo_.irfs.kpnk_ez);
...
kappa_et_MMB = 0.12 * exp(oo_.irfs.kpnk_et);
