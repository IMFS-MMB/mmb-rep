//Replication of the result of the paper by Kannan, Rabanal and Scott 2012
//Monetary and Macroprudential Policy Rules in a Model with House Price Booms;
//Qianchao Qu, May 21st, 2012;
//this file is for replicating the impulse responses under the baseline Taylor rule; 
