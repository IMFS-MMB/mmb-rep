function [residual, g1, g2, g3] = NK_GM07_rep_dynamic(y, x, params, steady_state, it_)
%
...
residual(11)= lhs-rhs;
lhs =y(24);
rhs =(1-params(35))*(y(27)*(1+params(33))+y(7)*params(34))+params(35)*y(5)+x(it_, 5);
residual(12)= lhs-rhs;
lhs =y(22);
rhs =y(11)+y(13)-y(14);
residual(13)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(11,21)=(-T123);
  g1(12,27)=(-((1-params(35))*(1+params(33))));
