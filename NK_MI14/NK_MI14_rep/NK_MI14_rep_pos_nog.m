...
erase_compiled_function('NK_MI14_rep_pos_nog_static');
erase_compiled_function('NK_MI14_rep_pos_nog_dynamic');
M_.orig_eq_nbr = 15;
M_.eq_nbr = 15;
M_.ramsey_eq_nbr = 0;
...
y_ss = M_.params( 29 );
M_.params( 30 ) = (M_.params(29)-M_.params(21)*M_.params(6)*M_.params(24)/(M_.params(7)*M_.params(19)^(-M_.params(8))))/(1+M_.params(1)/2*oo_.steady_state(3)^2);
c_ss = M_.params( 30 );
%
...
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',1:1,'value',18*M_.params(15)) ];
M_.exo_det_length = 0;
options_.periods = 15000;
perfect_foresight_setup;
perfect_foresight_solver;
save('NK_MI14_rep_pos_nog_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('NK_MI14_rep_pos_nog_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('NK_MI14_rep_pos_nog_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('NK_MI14_rep_pos_nog_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('NK_MI14_rep_pos_nog_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('NK_MI14_rep_pos_nog_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('NK_MI14_rep_pos_nog_results.mat', 'oo_recursive_', '-append');
end
