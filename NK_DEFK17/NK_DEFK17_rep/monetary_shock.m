...
erase_compiled_function('monetary_shock_static');
erase_compiled_function('monetary_shock_dynamic');
M_.orig_eq_nbr = 40;
M_.eq_nbr = 40;
M_.ramsey_eq_nbr = 0;
...
struct('exo_det',0,'exo_id',3,'multiplicative',0,'periods',1:1,'value',0.000625) ];
M_.exo_det_length = 0;
options_.periods = 300;
perfect_foresight_setup;
perfect_foresight_solver;
save('monetary_shock_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('monetary_shock_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('monetary_shock_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('monetary_shock_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('monetary_shock_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('monetary_shock_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('monetary_shock_results.mat', 'oo_recursive_', '-append');
end
